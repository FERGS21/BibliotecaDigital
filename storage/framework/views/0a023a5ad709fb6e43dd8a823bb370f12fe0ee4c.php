    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id='changePasswordForm'>
                ...
                Nota: Esto es solo una interfaz de usuario. Necesita desarrollar Backend para la actualización
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12">
                            <label>Confirmar nueva contraseña:</label><span
                                    class="required confirm-pwd"></span><span class="required">*</span>
                            <div class="input-group">
...
<?php
 ?><?php /**PATH C:\Users\FER\Documents\5TO_SEMESTRE\BASE_DE_DATOS\BibliotecaDigital\resources\views/profile/change_password.blade.php ENDPATH**/ ?>